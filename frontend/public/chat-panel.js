var ChatPanel=function(y){"use strict";const J="nc_chatpanel_root",Le="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css";let M=null;function b(){var t;const e=M;return!e||typeof window>"u"?null:((t=window.__ncMapRegistry__)==null?void 0:t[e])??null}function k(){return window.maplibregl}const Ce="http://localhost:3001/api/n8n",Ee="http://localhost:3001/api",j="nc_chatpanel_n8n_news_v1",ke=60*60*1e3,Se="Merhaba, Ben Alanya Belediyesi Kent Rehberi'niz Neco. Size nasıl yardımcı olabilirim?",U="nc_search_scan_styles",B="nc_search_scan_overlay",S="nc_map_magnify_lens_root",W=252,Y=2.5;let w=null,v=0,x=null;function Ae(){if(typeof document>"u"||document.getElementById(U))return;const e=document.createElement("style");e.id=U,e.textContent=`
