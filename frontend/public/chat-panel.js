var ChatPanel=function(w){"use strict";function y(e){requestAnimationFrame(()=>{e.scrollTop=e.scrollHeight})}function m(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function N(e){return typeof e=="object"&&e!==null&&!Array.isArray(e)}const Q="nc_chatpanel_root",Ie="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/css/bootstrap.min.css";let B=null;function g(){var t;const e=B;return!e||typeof window>"u"?null:((t=window.__ncMapRegistry__)==null?void 0:t[e])??null}function M(){return window.maplibregl}const He="http://localhost:3001/api/n8n",De="http://localhost:3001/api",ee="nc_chatpanel_n8n_news_v1",$e=60*60*1e3,Re="Merhaba, Ben Alanya Belediyesi Kent Rehberi'niz Neco. Size nasıl yardımcı olabilirim?",te="nc_search_scan_styles",O="nc_search_scan_overlay",T="nc_map_magnify_lens_root",ne=252,I=2.5,qe=500;let L=null,v=null;function H(){try{v==null||v()}catch{}}let E=0,C=null;function ze(){if(typeof document>"u"||document.getElementById(te))return;const e=document.createElement("style");e.id=te,e.textContent=`
